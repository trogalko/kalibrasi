...
namespace Kalibrasi.Data.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the MHakAkses Entity. It will perform database oriented actions for
	/// a entity of type 'MHakAksesEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class MHakAksesDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public MHakAksesDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "MHakAksesEntity", new MHakAksesEntityFactory())
		{
		}
		...
		internal MHakAksesDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'MHakAksesEntity' in a datatable which match the specified filter. 
