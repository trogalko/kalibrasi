...
namespace Kalibrasi.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MLokasi'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MLokasiEntity : CommonEntityBase, ISerializable
			...
			
	{
		...
		static MLokasiEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public MLokasiEntity()
		{
			InitClassEmpty(null);
		}
		...
		/// <summary>CTor</summary>
		/// <param name="cIdLokasi">PK value for MLokasi which data should be fetched into this MLokasi object</param>
		public MLokasiEntity(System.String cIdLokasi)
		{
			InitClassFetch(cIdLokasi, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="cIdLokasi">PK value for MLokasi which data should be fetched into this MLokasi object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public MLokasiEntity(System.String cIdLokasi, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(cIdLokasi, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="cIdLokasi">PK value for MLokasi which data should be fetched into this MLokasi object</param>
		/// <param name="validator">The custom validator object for this MLokasiEntity</param>
		public MLokasiEntity(System.String cIdLokasi, IValidator validator)
		{
			InitClassFetch(cIdLokasi, validator, null);
		}
		...
		protected MLokasiEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MLokasiFieldIndex)fieldIndex)
			{
				case MLokasiFieldIndex.CUserId:
		...
		{
			return MLokasiEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Muser":
					toReturn.Add(MLokasiEntity.Relations.MUserEntityUsingCUserId);
					break;
		...
		public bool FetchUsingPK(System.String cIdLokasi)
		{
			return FetchUsingPK(cIdLokasi, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.String cIdLokasi, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(cIdLokasi, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.String cIdLokasi, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(cIdLokasi, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.String cIdLokasi, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(cIdLokasi, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.CIdLokasi, null, null, null);
		}
		...
		public bool TestOriginalFieldValueForNull(MLokasiFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MLokasiFieldIndex fieldIndex)
		{
		...
		{
			return new MLokasiRelations().GetAllRelations();
		}
		...
		public virtual MUserEntity GetSingleMuser(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(MLokasiEntity.Relations.MUserEntityUsingCUserId);
		...
		{
			MLokasiDAO dao = (MLokasiDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Kalibrasi.Data.EntityType.MLokasiEntity);
		}
		...
		/// <param name="cIdLokasi">PK value for MLokasi which data should be fetched into this MLokasi object</param>
		/// <param name="validator">The validator object for this MLokasiEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.String cIdLokasi, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(cIdLokasi, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _muser, new PropertyChangedEventHandler( OnMuserPropertyChanged ), "Muser", MLokasiEntity.Relations.MUserEntityUsingCUserId, true, signalRelatedEntity, "Mlokasi", resetFKFields, new int[] { (int)MLokasiFieldIndex.CUserId } );		
			_muser = null;
		}
		...
		private void SetupSyncMuser(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _muser, new PropertyChangedEventHandler( OnMuserPropertyChanged ), "Muser", MLokasiEntity.Relations.MUserEntityUsingCUserId, true, ref _alreadyFetchedMuser, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.String cIdLokasi, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)MLokasiFieldIndex.CIdLokasi].ForcedCurrentValueWrite(cIdLokasi);
		...
		{
			return DAOFactory.CreateMLokasiDAO();
		}
		...
		{
			return new MLokasiEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static MLokasiRelations Relations
		{
			get	{ return new MLokasiRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathMuser
		{
			get
			{
				return new PrefetchPathElement(new Kalibrasi.Data.CollectionClasses.MUserCollection(),
					(IEntityRelation)GetRelationsForField("Muser")[0], (int)Kalibrasi.Data.EntityType.MLokasiEntity, (int)Kalibrasi.Data.EntityType.MUserEntity, 0, null, null, null, "Muser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return MLokasiEntity.CustomProperties;}
		}
		...
		{
			get { return MLokasiEntity.FieldsCustomProperties;}
		}

		/// <summary> The CUserId property of the Entity MLokasi<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "M_Lokasi"."C_UserId"<br/>
		...
		{
			get { return (System.String)GetValue((int)MLokasiFieldIndex.CUserId, true); }
			set	{ SetValue((int)MLokasiFieldIndex.CUserId, value, true); }
		}
		/// <summary> The CIdLokasi property of the Entity MLokasi<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "M_Lokasi"."C_IdLokasi"<br/>
		...
		{
			get { return (System.String)GetValue((int)MLokasiFieldIndex.CIdLokasi, true); }
			set	{ SetValue((int)MLokasiFieldIndex.CIdLokasi, value, true); }
		}
		/// <summary> The CIdDept property of the Entity MLokasi<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "M_Lokasi"."C_IdDept"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarWChar, 0, 0, 15<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String CIdDept
		{
			get { return (System.String)GetValue((int)MLokasiFieldIndex.CIdDept, true); }
			set	{ SetValue((int)MLokasiFieldIndex.CIdDept, value, true); }
		}
		/// <summary> The CNamaLokasi property of the Entity MLokasi<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "M_Lokasi"."C_NamaLokasi"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarWChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String CNamaLokasi
		{
			get { return (System.String)GetValue((int)MLokasiFieldIndex.CNamaLokasi, true); }
			set	{ SetValue((int)MLokasiFieldIndex.CNamaLokasi, value, true); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_muser != null)
						{
							_muser.UnsetRelatedEntity(this, "Mlokasi");
						}
					}
					else
					{
						if(_muser!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "Mlokasi");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Kalibrasi.Data.EntityType.MLokasiEntity; }
		}
		#endregion
