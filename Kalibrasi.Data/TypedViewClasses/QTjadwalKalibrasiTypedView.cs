...
namespace Kalibrasi.Data.TypedViewClasses
{
	...
	/// <summary>
	/// Typed datatable for the view 'QTjadwalKalibrasi'.<br/><br/>
	/// 
	/// </summary>
	/// <remarks>
...
#endif	
	public partial class QTjadwalKalibrasiTypedView : TypedViewBase<QTjadwalKalibrasiRow>, ITypedView
			...
			
	{
		...
		/// </summary>
		static QTjadwalKalibrasiTypedView()
		{
		...
		/// CTor
		/// </summary>
		public QTjadwalKalibrasiTypedView():base("QTjadwalKalibrasi")
		{
			InitClass();
		}
		...
		protected QTjadwalKalibrasiTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
#endif
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.QTjadwalKalibrasiTypedView);
		}


		/// <summary>Gets an array of all QTjadwalKalibrasiRow objects.</summary>
		/// <returns>Array with QTjadwalKalibrasiRow objects</returns>
		public new QTjadwalKalibrasiRow[] Select()
		{
			return (QTjadwalKalibrasiRow[])base.Select();
		}


		/// <summary>Gets an array of all QTjadwalKalibrasiRow objects that match the filter criteria in order of primary key (or lacking one, order of addition.) </summary>
		/// <param name="filterExpression">The criteria to use to filter the rows.</param>
		/// <returns>Array with QTjadwalKalibrasiRow objects</returns>
		public new QTjadwalKalibrasiRow[] Select(string filterExpression)
		{
			return (QTjadwalKalibrasiRow[])base.Select(filterExpression);
		}


		/// <summary>Gets an array of all QTjadwalKalibrasiRow objects that match the filter criteria, in the specified sort order</summary>
		/// <param name="filterExpression">The filter expression.</param>
		/// <param name="sort">A string specifying the column and sort direction.</param>
		/// <returns>Array with QTjadwalKalibrasiRow objects</returns>
		public new QTjadwalKalibrasiRow[] Select(string filterExpression, string sort)
		{
			return (QTjadwalKalibrasiRow[])base.Select(filterExpression, sort);
		}


		/// <summary>Gets an array of all QTjadwalKalibrasiRow objects that match the filter criteria, in the specified sort order that match the specified state</summary>
		/// <param name="filterExpression">The filter expression.</param>
		/// <param name="sort">A string specifying the column and sort direction.</param>
		/// <param name="recordStates">One of the <see cref="System.Data.DataViewRowState"/> values.</param>
		/// <returns>Array with QTjadwalKalibrasiRow objects</returns>
		public new QTjadwalKalibrasiRow[] Select(string filterExpression, string sort, DataViewRowState recordStates)
		{
			return (QTjadwalKalibrasiRow[])base.Select(filterExpression, sort, recordStates);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.QTjadwalKalibrasiTypedView);
			TypedListDAO dao = DAOFactory.CreateTypedListDAO();
		...
		{
			return new QTjadwalKalibrasiRow(rowBuilder);
		}
		...
		{
			return typeof(QTjadwalKalibrasiRow);
		}
		...
		{
			QTjadwalKalibrasiTypedView cloneToReturn = ((QTjadwalKalibrasiTypedView)(base.Clone()));
		...
		{
			return new QTjadwalKalibrasiTypedView();
		}
#endif
		...
		{
			get { return QTjadwalKalibrasiTypedView.CustomProperties;}
		}
		...
		{
			get { return QTjadwalKalibrasiTypedView.FieldsCustomProperties;}
		}

		/// <summary>
		/// Indexer of this strong typed view
		/// </summary>
		public QTjadwalKalibrasiRow this[int index] 
		{
			get 
			{
				return ((QTjadwalKalibrasiRow)(this.Rows[index]));
			}
		}
	...
	/// <summary>
	/// Typed datarow for the typed datatable QTjadwalKalibrasi
	/// </summary>
	public partial class QTjadwalKalibrasiRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private QTjadwalKalibrasiTypedView	_parent;
		#endregion
		...
		protected internal QTjadwalKalibrasiRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((QTjadwalKalibrasiTypedView)(this.Table));
		}
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."C_IdAlat"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."C_NamaAlat"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."C_NamaDept"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."C_NamaLokasi"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."D_Plan"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."D_ConfirmRencana"<br/>
		/// View field characteristics (type, precision, scale, length): Date, 0, 0, 0
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."D_Realisation"<br/>
		/// View field characteristics (type, precision, scale, length): Date, 0, 0, 0
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."C_PIC"<br/>
		/// View field characteristics (type, precision, scale, length): VarWChar, 0, 0, 100
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."M_Keterangan"<br/>
		...
		/// </summary>
		/// <remarks>
		/// Mapped on view field: "Q_TJadwalKalibrasi"."N_Interval"<br/>
